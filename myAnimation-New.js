...
lib.ssMetadata = [
		{name:"myAnimation_New_atlas_1", frames: [[0,665,323,189],[0,0,449,663],[1115,636,181,349],[680,636,248,313],[1964,415,78,32],[1733,415,229,404],[1505,415,226,413],[1740,0,227,413],[1505,0,233,413],[1733,821,280,127],[1298,830,346,127],[930,636,183,348],[0,856,137,100],[139,856,137,100],[1298,636,136,103],[451,636,227,401],[451,0,1052,210],[451,212,1052,210],[451,424,1052,210]]}
];
...
(lib.CachedBmp_19 = function() {
	this.initialize(ss["myAnimation_New_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-0.1,-13.1,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(526));
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(0.7,5.35,0.5,0.5);

	this.instance_2 = new lib.CachedBmp_3();
	this.instance_2.setTransform(0.7,5.35,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},524).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(39,18.6,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(3));

	// button
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#666666").ss(1,1,1).p("AqOldIUdAAQBJAAA5AlQAVAOASATQBHBGAABkIAADbQAABkhHBGQgSASgVAOQg5AmhJAAI0dAAQhkAAhGhGQhGhGAAhkIAAjbQAAhkBGhGQBGhGBkAAg");
	this.shape.setTransform(89.5,35);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#999999").s().p("AqOFeQhkAAhGhHQhGhGAAhjIAAjbQAAhkBGhGQBGhGBkAAIUdAAQBJAAA5AmQAVANATATQBGBGAABkIAADbQAABjhGBGQgTATgVAOQg5AmhJAAg");
	this.shape_1.setTransform(89.5,35);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#666666").ss(1,1,1).p("AqOldIUdAAQBjAABGBGQBHBGAABkIAADbQAABkhHBGQhGBGhjAAI0dAAQhkAAhGhGQhGhGAAhkIAAjbQAAhkBGhGQBGhGBkAAg");
	this.shape_2.setTransform(89.5,35);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#CCCCCC").s().p("AqOFeQhkAAhGhHQhGhGAAhjIAAjbQAAhkBGhGQBGhGBkAAIUdAAQBjAABHBGQBGBGAABkIAADbQAABjhGBGQhHBHhjAAg");
	this.shape_3.setTransform(89.5,35);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#666666").s().p("AqOFeQhkAAhGhHQhGhGAAhjIAAjbQAAhkBGhGQBGhGBkAAIUdAAQBjAABHBGQBGBGAABkIAADbQAABjhGBGQhHBHhjAAg");
	this.shape_4.setTransform(89.5,35);
...
p.nominalBounds = new cjs.Rectangle(-1,-1,181,83.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(19.05,18.6,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-1,-1,193.1,83.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-4.6,-1.3,0.4089,0.4089);
...
p.nominalBounds = new cjs.Rectangle(-4.6,-1.3,56,42.099999999999994);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(48).to({_off:false},0).wait(1).to({regX:80.7,regY:34.2,x:624.7,y:120.3},0).wait(1).to({x:617.05,y:120.1},0).wait(1).to({x:609.4,y:119.95},0).wait(1).to({x:601.7,y:119.75},0).wait(1).to({x:594.05,y:119.55},0).wait(1).to({x:586.4,y:119.4},0).wait(1).to({x:576.1},0).wait(1).to({x:565.8},0).wait(1).to({x:555.5},0).wait(1).to({x:545.2},0).wait(1).to({x:534.9},0).wait(1).to({x:524.6},0).wait(1).to({x:514.3},0).wait(1).to({x:504},0).wait(1).to({x:493.7},0).wait(1).to({x:483.4},0).wait(1).to({x:488.5},0).wait(1).to({x:493.65},0).wait(1).to({x:498.75},0).wait(1).to({x:503.9},0).wait(1).to({x:509},0).wait(1).to({x:514.15},0).wait(1).to({x:519.25},0).wait(1).to({x:524.4},0).wait(1).to({x:517.85},0).wait(1).to({x:511.3},0).wait(1).to({x:504.75},0).wait(1).to({x:498.2},0).wait(1).to({x:491.65},0).wait(1).to({x:485.1},0).wait(1).to({x:478.55},0).wait(1).to({x:472},0).wait(1).to({x:465.45},0).wait(1).to({x:458.9},0).wait(1).to({x:452.35},0).wait(1).to({x:445.8},0).wait(1).to({x:434},0).wait(1).to({x:422.2},0).wait(1).to({x:410.45},0).wait(1).to({x:398.65},0).wait(1).to({x:386.85},0).wait(1).to({x:375.1},0).wait(1).to({x:363.3},0).wait(1).to({x:351.5},0).wait(1).to({x:339.75},0).wait(1).to({x:327.95},0).wait(1).to({x:316.15},0).wait(1).to({x:304.4},0).wait(1).to({x:292.6},0).wait(1).to({x:280.8},0).wait(1).to({x:269.05},0).wait(1).to({x:259.1},0).wait(1).to({x:249.15},0).wait(1).to({x:239.25},0).wait(1).to({x:229.3},0).wait(1).to({x:219.4},0).wait(1).to({x:209.45},0).wait(1).to({x:199.5},0).wait(1).to({x:189.6},0).wait(1).to({x:179.65},0).wait(1).to({x:169.75},0).wait(1).to({x:159.8},0).wait(1).to({x:149.85},0).wait(1).to({x:139.95},0).wait(1).to({x:130},0).wait(1).to({x:120.1},0).wait(1).to({x:111.45},0).wait(1).to({x:102.85},0).wait(1).to({x:94.25},0).wait(1).to({x:85.6},0).wait(1).to({x:77.05},0).wait(1).to({x:68.45},0).wait(1).to({x:59.8},0).wait(1).to({x:51.2},0).wait(1).to({x:42.6},0).wait(1).to({x:33.95},0).wait(1).to({x:25.35},0).wait(1).to({x:16.75},0).wait(1).to({x:8.15},0).wait(1).to({x:-0.5},0).wait(1).to({x:-9.1},0).wait(1).to({x:-17.7},0).wait(1).to({x:-26.35},0).wait(1).to({x:-34.95},0).wait(1).to({x:-43.55},0).wait(1).to({x:-52.2},0).wait(1).to({x:-60.8},0).wait(1).to({x:-69.4},0).wait(1).to({x:-78},0).wait(1).to({x:-86.65},0).wait(1).to({x:-95.25},0).wait(1).to({x:-103.85},0).wait(1).to({x:-112.5},0).wait(1).to({x:-121.1},0).wait(1).to({x:-129.7},0).wait(1).to({x:-138.35},0).wait(2).to({_off:true},1).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({startPosition:0},0).wait(524).to({startPosition:0},0).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	// button
	this.animationButton = new lib.button1();
	this.animationButton.name = "animationButton";
	this.animationButton.setTransform(333.6,242.65,0.9999,0.9999,0,0,0,89.6,35.1);
	new cjs.ButtonHelper(this.animationButton, 0, 1, 2);

	this.playAgainButton = new lib.button2();
	this.playAgainButton.name = "playAgainButton";
	this.playAgainButton.setTransform(185.5,211.9);
	new cjs.ButtonHelper(this.playAgainButton, 0, 1, 2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.animationButton}]}).to({state:[]},1).to({state:[{t:this.playAgainButton}]},524).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance}]},1).to({state:[{t:this.instance_1}]},72).to({state:[{t:this.instance_2}]},74).to({state:[{t:this.instance_2}]},165).to({state:[{t:this.instance_1}]},44).to({state:[{t:this.instance}]},57).to({state:[{t:this.instance}]},15).to({state:[{t:this.instance}]},25).wait(72));
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).to({_off:true},72).wait(340).to({_off:false},0).wait(112));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-26.55,3.2,0.8333,0.8333,0,15.004,-164.996,21.8,12.8);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(241).to({_off:false},0).wait(1).to({regX:23.4,regY:19.8,scaleX:0.8477,scaleY:0.8477,skewX:15.0248,skewY:-164.9752,x:-25.1,y:15.9},0).wait(1).to({scaleX:0.862,scaleY:0.862,skewX:15.0443,skewY:-164.9557,x:-21,y:23.35},0).wait(1).to({scaleX:0.8763,scaleY:0.8763,skewX:15.0639,skewY:-164.9361,x:-16.75,y:30.75},0).wait(1).to({scaleX:0.8907,scaleY:0.8907,skewX:15.0834,skewY:-164.9166,x:-12.55,y:38.25},0).wait(1).to({scaleX:0.905,scaleY:0.905,skewX:15.103,skewY:-164.897,x:-8.35,y:45.65},0).wait(1).to({scaleX:0.9193,scaleY:0.9193,skewX:15.1225,skewY:-164.8775,x:-4.15,y:53.05},0).wait(1).to({scaleX:0.9336,scaleY:0.9336,skewX:15.1421,skewY:-164.8579,x:0,y:60.5},0).wait(1).to({scaleX:0.948,scaleY:0.948,skewX:15.1616,skewY:-164.8384,x:4.3,y:67.95},0).wait(1).to({scaleX:0.9623,scaleY:0.9623,skewX:15.1811,skewY:-164.8189,x:8.45,y:75.4},0).wait(1).to({scaleX:0.9766,scaleY:0.9766,skewX:15.2007,skewY:-164.7993,x:12.7,y:82.8},0).wait(1).to({scaleX:0.9909,scaleY:0.9909,skewX:15.2202,skewY:-164.7798,x:16.9,y:90.25},0).wait(1).to({scaleX:1.0053,scaleY:1.0053,skewX:15.2398,skewY:-164.7602,x:21.05,y:97.65},0).wait(1).to({scaleX:1.0196,scaleY:1.0196,skewX:15.2593,skewY:-164.7407,x:25.3,y:105.1},0).wait(1).to({scaleX:1.0339,scaleY:1.0339,skewX:15.2789,skewY:-164.7211,x:29.45,y:112.55},0).wait(1).to({scaleX:1.0483,scaleY:1.0483,skewX:15.2984,skewY:-164.7016,x:33.7,y:120},0).wait(1).to({scaleX:1.0626,scaleY:1.0626,skewX:15.318,skewY:-164.682,x:37.9,y:127.45},0).wait(1).to({scaleX:1.0769,scaleY:1.0769,skewX:15.3375,skewY:-164.6625,x:42.1,y:134.85},0).wait(1).to({scaleX:1.0712,scaleY:1.0712,skewX:15.329,skewY:-164.671,x:43.8,y:143.7},0).wait(1).to({scaleX:1.0655,scaleY:1.0655,skewX:15.3205,skewY:-164.6795,x:45.45,y:152.6},0).wait(1).to({scaleX:1.0598,scaleY:1.0598,skewX:15.312,skewY:-164.688,x:47.1,y:161.5},0).wait(1).to({scaleX:1.0541,scaleY:1.0541,skewX:15.3034,skewY:-164.6966,x:48.75,y:170.4},0).wait(1).to({scaleX:1.0484,scaleY:1.0484,skewX:15.2949,skewY:-164.7051,x:50.35,y:179.2},0).wait(1).to({scaleX:1.0427,scaleY:1.0427,skewX:15.2864,skewY:-164.7136,x:52,y:188.05},0).wait(1).to({scaleX:1.0369,scaleY:1.0369,skewX:15.2779,skewY:-164.7221,x:53.7,y:196.95},0).wait(1).to({scaleX:1.0312,scaleY:1.0312,skewX:15.2693,skewY:-164.7307,x:55.3,y:205.85},0).wait(1).to({scaleX:1.0255,scaleY:1.0255,skewX:15.2608,skewY:-164.7392,x:57,y:214.75},0).wait(1).to({scaleX:1.0198,scaleY:1.0198,skewX:15.2523,skewY:-164.7477,x:58.7,y:223.6},0).wait(1).to({scaleX:1.0141,scaleY:1.0141,skewX:15.2438,skewY:-164.7562,x:60.3,y:232.45},0).wait(1).to({scaleX:1.0084,scaleY:1.0084,skewX:15.2352,skewY:-164.7648,x:60.35,y:232.4},0).wait(1).to({scaleX:1.0027,scaleY:1.0027,skewX:15.2267,skewY:-164.7733},0).wait(1).to({scaleX:0.997,scaleY:0.997,skewX:15.2182,skewY:-164.7818,x:60.4},0).wait(1).to({scaleX:0.9913,scaleY:0.9913,skewX:15.2097,skewY:-164.7903,y:232.3},0).wait(1).to({scaleX:0.9855,scaleY:0.9855,skewX:15.2012,skewY:-164.7988,x:60.45},0).wait(1).to({scaleX:0.9798,scaleY:0.9798,skewX:15.1926,skewY:-164.8074,x:60.4,y:232.25},0).wait(1).to({scaleX:0.9741,scaleY:0.9741,skewX:15.1841,skewY:-164.8159,x:60.45,y:232.2},0).wait(1).to({scaleX:0.9684,scaleY:0.9684,skewX:15.1756,skewY:-164.8244,x:60.55,y:232.15},0).wait(1).to({scaleX:0.9627,scaleY:0.9627,skewX:15.1671,skewY:-164.8329,x:60.5},0).wait(1).to({scaleX:0.9685,scaleY:0.9685,skewX:15.1756,skewY:-164.8244,x:64.1,y:226.75},0).wait(1).to({scaleX:0.9743,scaleY:0.9743,skewX:15.1841,skewY:-164.8159,x:67.6,y:221.4},0).wait(1).to({scaleX:0.98,scaleY:0.98,skewX:15.1926,skewY:-164.8074,x:71.1,y:216.1},0).wait(1).to({scaleX:0.9858,scaleY:0.9858,skewX:15.2012,skewY:-164.7988,x:74.75,y:210.7},0).wait(1).to({scaleX:0.9916,scaleY:0.9916,skewX:15.2097,skewY:-164.7903,x:78.25,y:205.3},0).wait(1).to({scaleX:0.9974,scaleY:0.9974,skewX:15.2182,skewY:-164.7818,x:81.8,y:199.95},0).wait(1).to({scaleX:1.0031,scaleY:1.0031,skewX:15.2267,skewY:-164.7733,x:85.35,y:194.6},0).wait(1).to({scaleX:1.0089,scaleY:1.0089,skewX:15.2352,skewY:-164.7648,x:88.9,y:189.2},0).wait(1).to({scaleX:1.0147,scaleY:1.0147,skewX:15.2438,skewY:-164.7562,x:92.45,y:183.85},0).wait(1).to({scaleX:1.0204,scaleY:1.0204,skewX:15.2523,skewY:-164.7477,x:96,y:178.5},0).wait(1).to({scaleX:1.0262,scaleY:1.0262,skewX:15.2608,skewY:-164.7392,x:98.6,y:174.45},0).wait(1).to({scaleX:1.032,scaleY:1.032,skewX:15.2693,skewY:-164.7307,x:101.1,y:170.35},0).wait(1).to({scaleX:1.0378,scaleY:1.0378,skewX:15.2779,skewY:-164.7221,x:103.7,y:166.25},0).wait(1).to({scaleX:1.0435,scaleY:1.0435,skewX:15.2864,skewY:-164.7136,x:106.25,y:162.2},0).wait(1).to({scaleX:1.0493,scaleY:1.0493,skewX:15.2949,skewY:-164.7051,x:108.75,y:158.1},0).wait(1).to({scaleX:1.0551,scaleY:1.0551,skewX:15.3034,skewY:-164.6966,x:111.4,y:154.1},0).wait(1).to({scaleX:1.0609,scaleY:1.0609,skewX:15.312,skewY:-164.688,x:113.9,y:150},0).wait(1).to({scaleX:1.0666,scaleY:1.0666,skewX:15.3205,skewY:-164.6795,x:116.5,y:145.9},0).wait(1).to({scaleX:1.0724,scaleY:1.0724,skewX:15.329,skewY:-164.671,x:119.05,y:141.85},0).wait(1).to({scaleX:1.0782,scaleY:1.0782,skewX:15.3375,skewY:-164.6625,x:121.55,y:137.8},0).wait(1).to({x:122.15,y:139.95},0).wait(1).to({x:122.75,y:142.1},0).wait(1).to({x:123.35,y:144.25},0).wait(1).to({x:123.9,y:146.4},0).wait(1).to({x:124.5,y:148.55},0).wait(1).to({x:125.1,y:150.7},0).wait(1).to({x:125.65,y:152.9},0).wait(1).to({x:126.25,y:155.05},0).wait(1).to({x:126.85,y:157.2},0).wait(1).to({x:127.4,y:159.35},0).wait(1).to({x:128,y:161.5},0).wait(1).to({x:128.6,y:163.65},0).wait(1).to({x:129.15,y:165.8},0).wait(1).to({regX:22.1,regY:13.3,scaleX:1.0781,scaleY:1.0781,skewX:15.337,skewY:-164.663,x:132.65,y:158.85},0).wait(44).to({regX:19.8,regY:14.7,scaleX:1.2228,scaleY:1.2228,skewX:0.5856,skewY:-179.4144,y:158.9},0).wait(1).to({regX:23.4,regY:19.8,skewX:0.5866,skewY:-179.4134,x:124.45,y:168.35},0).wait(1).to({x:120.7,y:171.65},0).wait(1).to({x:117,y:174.95},0).wait(1).to({x:113.25,y:178.2},0).wait(1).to({x:109.55,y:181.5},0).wait(1).to({x:105.8,y:184.8},0).wait(1).to({x:102.1,y:188.1},0).wait(1).to({x:113.25,y:191.75},0).wait(1).to({x:124.45,y:195.4},0).wait(1).to({x:135.65,y:199.1},0).wait(1).to({x:146.85,y:202.75},0).wait(1).to({x:158.05,y:206.4},0).wait(1).to({x:169.25,y:210.1},0).wait(1).to({x:180.45,y:213.75},0).wait(1).to({x:191.65,y:217.4},0).wait(1).to({x:202.85,y:221.1},0).wait(1).to({x:214.05,y:224.75},0).wait(1).to({x:225.25,y:228.4},0).wait(1).to({x:236.45,y:232.1},0).wait(1).to({x:247.65,y:235.75},0).wait(1).to({x:258.85,y:239.4},0).wait(1).to({x:270.05,y:243.1},0).wait(1).to({x:276.8,y:244.5},0).wait(1).to({x:283.55,y:245.95},0).wait(1).to({x:290.3,y:247.4},0).wait(1).to({x:297.05,y:248.85},0).wait(1).to({x:303.8,y:250.3},0).wait(1).to({x:310.55,y:251.75},0).wait(1).to({x:317.3,y:253.2},0).wait(1).to({x:324.1,y:254.65},0).wait(1).to({x:330.85,y:256.05},0).wait(1).to({x:337.6,y:257.5},0).wait(1).to({x:344.35,y:258.95},0).wait(1).to({x:351.1,y:260.4},0).wait(1).to({x:357.85,y:261.85},0).wait(1).to({x:364.6,y:263.3},0).wait(1).to({x:371.35,y:264.75},0).wait(1).to({x:378.15,y:266.2},0).wait(1).to({x:378.9,y:265.45},0).wait(1).to({x:379.65,y:264.7},0).wait(1).to({x:380.45,y:264},0).wait(1).to({x:381.2,y:263.25},0).wait(1).to({x:381.95,y:262.55},0).wait(1).to({x:382.75,y:261.8},0).wait(1).to({x:383.5,y:261.1},0).wait(1).to({x:384.25,y:260.35},0).wait(1).to({x:385.05,y:259.65},0).wait(1).to({x:385.8,y:258.9},0).wait(1).to({x:386.6,y:258.2},0).wait(1).to({x:387.35,y:257.45},0).wait(1).to({x:388.1,y:256.75},0).wait(1).to({x:388.9,y:256},0).wait(1).to({x:389.65,y:255.3},0).wait(1).to({x:390.4,y:254.55},0).wait(1).to({x:391.2,y:253.85},0).wait(1).to({x:391.95,y:253.1},0).wait(1).to({x:392.75,y:252.4},0).wait(1).to({y:253.35},0).wait(1).to({y:254.35},0).wait(1).to({y:255.35},0).wait(1).to({x:392.8,y:256.3},0).wait(1).to({y:257.3},0).wait(1).to({y:258.3},0).wait(1).to({x:392.85,y:259.3},0).wait(1).to({y:260.25},0).wait(1).to({y:261.25},0).wait(1).to({y:262.25},0).wait(1).to({x:392.9,y:263.2},0).wait(1).to({y:264.2},0).wait(1).to({y:265.2},0).wait(1).to({x:392.95,y:266.2},0).wait(1).to({regX:20.2,regY:14.7,scaleX:1.2227,scaleY:1.2227,skewX:0.5863,skewY:-179.4137,x:397.5,y:260},0).wait(25).to({regX:20.4,scaleX:1.2228,scaleY:1.2228,skewX:0.5856,skewY:-179.4144,x:397.55,y:260.05},0).wait(1).to({regX:23.4,regY:19.8,skewX:0.5866,skewY:-179.4134,x:389.2,y:270.8},0).wait(1).to({x:384.55,y:275.35},0).wait(1).to({x:379.9,y:279.9},0).wait(1).to({x:375.25,y:284.5},0).wait(1).to({x:370.6,y:289.05},0).wait(1).to({x:365.95,y:293.6},0).wait(1).to({x:361.35,y:298.2},0).wait(1).to({x:366.6,y:286.95},0).wait(1).to({x:371.9,y:275.7},0).wait(1).to({x:377.15,y:264.5},0).wait(1).to({x:382.45,y:253.25},0).wait(1).to({x:387.75,y:242},0).wait(1).to({x:393,y:230.8},0).wait(1).to({x:398.3,y:219.55},0).wait(1).to({x:403.55,y:208.35},0).wait(1).to({x:408.85,y:197.1},0).wait(1).to({x:414.15,y:185.85},0).wait(1).to({x:419.4,y:174.65},0).wait(1).to({x:424.7,y:163.4},0).wait(1).to({x:430,y:152.2},0).wait(1).to({x:436.75,y:154.8},0).wait(1).to({x:443.5,y:157.4},0).wait(1).to({x:450.3,y:160},0).wait(1).to({x:457.05,y:162.6},0).wait(1).to({x:463.85,y:165.2},0).wait(1).to({x:470.6,y:167.8},0).wait(1).to({x:477.35,y:170.4},0).wait(1).to({x:484.15,y:173},0).wait(1).to({x:490.9,y:175.6},0).wait(1).to({x:497.7,y:178.2},0).wait(1).to({x:504,y:171.45},0).wait(1).to({x:510.35,y:164.7},0).wait(1).to({x:516.7,y:158},0).wait(1).to({x:523,y:151.25},0).wait(1).to({x:529.35,y:144.5},0).wait(1).to({x:535.7,y:137.8},0).wait(1).to({x:542,y:131.05},0).wait(1).to({x:548.35,y:124.3},0).wait(1).to({x:554.7,y:117.6},0).wait(1).to({x:561,y:110.85},0).wait(1).to({x:567.35,y:104.1},0).wait(1).to({x:573.7,y:97.4},0).wait(1).to({x:580,y:90.65},0).wait(1).to({x:586.35,y:83.9},0).wait(1).to({x:592.7,y:77.2},0).to({_off:true},1).wait(25));
...
// stage content:
(lib.myAnimationNew = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// timeline functions:
	this.frame_0 = function() {
		this.animationButton = this.button.animationButton;
		var self = this;
		self.stop();
		
		self.animationButton.addEventListener("click", startFunc)
	...
	this.frame_1 = function() {
		this.animationButton = undefined;
	}
	this.frame_525 = function() {
		this.playAgainButton = this.button.playAgainButton;
		this.___loopingOver___ = true;
		var self = this;
		self.stop();
		
		self.playAgainButton.addEventListener("click", startAgainFunc)
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(1).call(this.frame_1).wait(524).call(this.frame_525).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.button).wait(1).to({regX:399.7,regY:292.6,scaleX:1.383,scaleY:1.383,x:339.75},0).wait(524).to({regX:339.8,regY:248.3,scaleX:1,scaleY:1,x:339.8},0).wait(1));
	...
	this.leaf.layerIndex = 1
	this.leaf.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.leaf).wait(74).to({regX:37.6,regY:297.7,x:37.6,y:297.7},0).wait(73).to({regX:0,regY:0,x:0,y:0},0).to({_off:true},1).wait(378));
	...
	this.bird.layerIndex = 2
	this.bird.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.bird).wait(241).to({regX:2.9,regY:0.3,scaleX:1.0035,scaleY:1.0035,x:0.05},0).wait(1).to({regX:285.4,regY:154.9,scaleX:1,scaleY:1,x:282.6,y:154.65},0).wait(70).to({regX:0,regY:0,x:0,y:0},0).wait(45).to({regX:285.4,regY:154.9,x:285.4,y:154.9},0).wait(71).to({regX:0,regY:0,x:0,y:0},0).wait(26).to({regX:285.4,regY:154.9,x:285.4,y:154.9},0).wait(45).to({regX:0,regY:0,x:0,y:0},0).to({_off:true},25).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.boy).wait(1).to({regX:154.1,regY:113,scaleX:1.383,scaleY:1.383,x:0.05,y:-0.05},0).wait(72).to({regX:0,regY:0,scaleX:1,scaleY:1,x:0,y:0},0).wait(380).to({_off:true},72).wait(1));
	...
	this.baloons.layerIndex = 4
	this.baloons.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.baloons).wait(1).to({regX:154.1,regY:113,scaleX:1.383,scaleY:1.383,x:0.05,y:-0.05},0).wait(72).to({regX:0,regY:0,scaleX:1,scaleY:1,x:0,y:0},0).wait(1).to({regX:211.3,regY:148.3,x:211.3,y:148.3},0).wait(73).to({regX:0,regY:0,x:0,y:0},0).wait(210).to({regX:211.3,regY:148.3,x:211.3,y:148.3},0).wait(71).to({regX:0,regY:0,x:0,y:0},0).wait(26).to({regX:211.3,regY:148.3,x:211.3,y:148.3},0).wait(7).to({regX:0,regY:0,x:0,y:0},0).to({_off:true},64).wait(1));

	// tree_obj_
	this.tree = new lib.Scene_1_tree();
	this.tree.name = "tree";
	this.tree.setTransform(112.2,237.9,1,1,0,0,0,112.2,237.9);
	this.tree.depth = 0;
	this.tree.isAttachedToCamera = 0
	this.tree.isAttachedToMask = 0
	this.tree.layerDepth = 0
	this.tree.layerIndex = 5
	this.tree.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.tree).wait(1).to({regX:235.2,regY:285.1,scaleX:1.383,scaleY:1.383,x:112.25,y:237.95},0).wait(524).to({regX:112.2,regY:237.9,scaleX:1,scaleY:1,x:112.2,y:237.9},0).wait(1));
	...
	this.wind.layerIndex = 6
	this.wind.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.wind).wait(1).to({regX:154.1,regY:113,scaleX:1.383,scaleY:1.383,x:0.05,y:-0.05},0).wait(47).to({regX:0,regY:0,scaleX:1,scaleY:1,x:0,y:0},0).wait(1).to({regX:247,regY:119.9,x:247,y:119.9},0).wait(98).to({regX:0,regY:0,x:0,y:0},0).to({_off:true},1).wait(378));

	// clouds_obj_
	this.clouds = new lib.Scene_1_clouds();
	this.clouds.name = "clouds";
	this.clouds.setTransform(263.7,57.9,1,1,0,0,0,263.7,57.9);
	this.clouds.depth = 0;
	...
	this.timeline.addTween(cjs.Tween.get(this.clouds).wait(1).to({regX:344.7,regY:154.9,scaleX:1.383,scaleY:1.383},0).wait(524).to({regX:263.7,regY:57.9,scaleX:1,scaleY:1},0).wait(1));

	// sky_obj_
	this.sky = new lib.Scene_1_sky();
	this.sky.name = "sky";
	this.sky.setTransform(276.2,145.5,1,1,0,0,0,276.2,145.5);
	this.sky.depth = 0;
	...
	this.timeline.addTween(cjs.Tween.get(this.sky).wait(1).to({regX:353.8,regY:218.2,scaleX:1.383,scaleY:1.383,x:276.25,y:145.45},0).wait(524).to({regX:276.2,regY:145.5,scaleX:1,scaleY:1,x:276.2,y:145.5},0).wait(1));

	// grass_obj_
	this.grass = new lib.Scene_1_grass();
	this.grass.name = "grass";
	this.grass.setTransform(276.2,347.4,1,1,0,0,0,276.2,347.4);
	this.grass.depth = 0;
	this.grass.isAttachedToCamera = 0
	this.grass.isAttachedToMask = 0
	this.grass.layerDepth = 0
	this.grass.layerIndex = 9
	this.grass.maskLayerName = 0

	this.timeline.addTween(cjs.Tween.get(this.grass).wait(1).to({regX:353.7,regY:364.2,scaleX:1.383,scaleY:1.383,x:276.15,y:347.35},0).wait(524).to({regX:276.2,regY:347.4,scaleX:1,scaleY:1,x:276.2,y:347.4},0).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(55.9,175.8,657.2,309.09999999999997);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/myAnimation_New_atlas_1.png?1650373368227", id:"myAnimation_New_atlas_1"}
	],
	preloads: []
};
